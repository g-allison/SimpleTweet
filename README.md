...
* [X] Made profile pictures circuler to make Twitter UI
* [X] Added user's name and @
* [X] Made username bold to match Twitter UI
* [X] Removed link for image from the body of the tweet so it has cleaner look
